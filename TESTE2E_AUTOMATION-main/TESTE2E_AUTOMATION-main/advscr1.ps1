...
(
    ...
    [ValidateNotNullOrEmpty()]
     [string] $PSScriptRoot= 'C:\Users\PRATHYUSHA\Source\Repos\tictactoe',
    [string] $Path = 'C:\Users\PRATHYUSHA\Source\Repos\tictactoe\TicTacToe\Program.cs',
 #"$PSScriptRoot\TicTacToe\Program.cs",
    ...
    [string] $ResultsDirectory = "$PSScriptRoot\TicTacToe\TestResult",
